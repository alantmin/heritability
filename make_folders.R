...
for(i in indexes) {
	...
	if(!is.null(g)) {
		...
		result_hsq = c(gold_standard[1], dicker2[1], dicker1[1], schwartzman[1], MoM_no_diag[1], MoM_diag[1], gcta_maxlike[1], ldak_res_1[1], ldak_res_2[1])
		sigmag = c(gold_standard[2], dicker2[2], dicker1[2], schwartzman[2], MoM_no_diag[2], MoM_diag[2], gcta_maxlike[2], ldak_res_1[2], ldak_res_2[2])
		sigmae = c(gold_standard[3], dicker2[3], dicker1[3], schwartzman[3], MoM_no_diag[3], MoM_diag[3], gcta_maxlike[3], ldak_res_1[3], ldak_res_2[3])
